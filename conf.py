...
htmlhelp_basename = 'AlloyDocumentationdoc'
...
latex_documents = [
    (master_doc, 'AlloyDocumentation.tex', 'Alloy Documentation Documentation',
     'Alloy Board', 'manual'),
]
...
man_pages = [
    (master_doc, 'alloydocumentation', 'Alloy Documentation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AlloyDocumentation', 'Alloy Documentation Documentation',
     author, 'AlloyDocumentation', 'One line description of project.',
     'Miscellaneous'),
]
...
# We use brackets, not parenthesis
